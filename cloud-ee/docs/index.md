...
```bash
ansible-builder build --file cloud-ee.yaml --tag cloud-ee:latest --container-runtime podman
```
...
- **cloud-ee.yaml**: This is your EE's "blueprint." It's the main definition file that ansible-builder will use to construct your image.
- **cloud-ee-template.yaml**: This is the Ansible self-service automation portal template file that generated this. You can import it and use it as a base to create new templates for your portal.
...
```bash
# This command uses your 'cloud-ee.yaml' file to build an image
# and tags it as 'cloud-ee:latest'
...
```bash
ansible-navigator run playbook.yml --eei cloud-ee:latest --pull-policy missing
```
...
podman tag cloud-ee:latest your-pah-hostname/cloud-ee:latest

# Login to your Private Automation Hub
podman login your-pah-hostname

# Push the image
podman push your-pah-hostname/cloud-ee:latest
```
...
podman tag cloud-ee:latest your-internal-registry.com/cloud-ee:latest
podman login your-internal-registry.com
podman push your-internal-registry.com/cloud-ee:latest
```
...
If you want to reuse this execution environment template for future projects, you can import the generated **cloud-ee.yaml** file into your self-service automation portal.
...
2. **Import from Git repository**: Enter the Git SCM URL containing your `cloud-ee.yaml` file, click **Analyze** to validate, review the details, then click **Import**.
